...
app.controller("AdminSlider", ["$scope", "$http", "$timeout", "$filter", "scrutinyService", function ($scope, $http, $timeout, $filter, scrutinyService) {
    ...
    $scope.submit = function () {
        ...
        if ($scope.slider.Id === "" || $scope.file.a !== null) {
    ...
    $scope.save = function (file) {
        ...
        fd.append('heading', $scope.slider.heading);
        fd.append('Id', $scope.slider.Id);
        fd.append('subHeading', $scope.slider.subHeading);
        fd.append('base64', $scope.newimage);
        fd.append('imageUrl', $scope.slider.imageUrl);
        fd.append('isEnabled', $scope.slider.isEnabled);

        $http({
            url: "/MainSliderAdmin/SaveBlogs/",
            method: "Post",
            data: fd,
            processData: false,
            contentType: false,
    ...
    $scope.GetEditData = function (i) {
        ...
        $http({
            ...
            $scope.slider.Id = res.data.data.id;
            $scope.slider.heading = res.data.data.heading;
            $scope.slider.subHeading = res.data.data.subHeading;
            $scope.slider.imageUrl = res.data.data.imageUrl;
            $scope.disable = false;
            $scope.slider.isEnabled = res.data.data.isEnabled;
            $('#loading').attr('style', 'display: none  !important');
    ...
    $scope.PostStatus = function (id, flag) {
        ...
        $http({
            url: "/MainSliderAdmin/PostStatus/",
            method: "Post",
            data: fd,
            transformRequest: angular.identity,
            headers: { 'Content-Type': undefined }
    ...
    $scope.DeleteBlog = function (id) {
        ...
        fd.append('id', id);
        $http({
            url: "/MainSliderAdmin/DeleteBlog/",
            method: "Post",
            data: fd,
            transformRequest: angular.identity,
            headers: { 'Content-Type': undefined }
