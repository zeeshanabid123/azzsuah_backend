...
app.controller("BankInfo", ["$scope", "$http", "$timeout", "$filter", "scrutinyService", function ($scope, $http, $timeout, $filter, scrutinyService) {
    ...
    $scope.save = function () {
        ...
        $http({
            ...
            if (res.data) {
                ...
                $scope.GetEditData("A5C5FC89-4226-4FA7-AC45-95CE8988791D");
            } else {
