...
app.controller("ClientReport", ["$scope", "$http", "GetService", "commonService", function ($scope, $http, GetService, commonService) {
    //#region DatePicker
    ...
    $scope.loadForwardedCases = function () {
        $("#loader").show();
        GetService.getClientMonthlyReports(setPaginationOffset($scope.forwardedPagination), $scope.dateRang.str, $scope.dateRang.end, "/Report/GetClientMonthlyReportFromService").then(function (data) {
