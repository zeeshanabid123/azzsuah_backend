...
app.controller("ContactInfo", ["$scope", "$http", "$timeout", "$filter", "scrutinyService", function ($scope, $http, $timeout, $filter, scrutinyService) {
    ...
    $scope.save = function () {
        ...
        $http({
            ...
            if (res.data) {
                ...
                $scope.GetEditData("33D30F1E-B03D-436D-9A12-49AC06DAF35B");
            } else {
