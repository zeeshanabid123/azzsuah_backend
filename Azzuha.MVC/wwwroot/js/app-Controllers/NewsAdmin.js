...
app.controller("NewsAdmin", ["$scope", "$http", "$timeout", "$filter", "scrutinyService", function ($scope, $http, $timeout, $filter, scrutinyService) {
    ...
    $scope.save = function () {
        ...
        $http({
            ...
            if (res.data) {
                ...
                $scope.GetEditData("729A7E00-BD99-427D-972D-CFF7BA4E4C3B");
            } else {
