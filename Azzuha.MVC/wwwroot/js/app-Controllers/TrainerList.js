...
app.controller("TrainerList", ["$scope", "$http", "GetService", "commonService", function ($scope, $http, GetService, commonService) {
    //#region DatePicker
    ...
    $scope.loadForwardedCases = function () {
        ...
        GetService.loadForwardedCases(setPaginationOffset($scope.forwardedPagination), $scope.dateRang.str, $scope.dateRang.end, "/Profile/GetData", profileTypeId).then(function (data) {
