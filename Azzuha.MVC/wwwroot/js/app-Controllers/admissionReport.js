...
app.controller("admissionReport", ["$scope", "$http", "GetService", "commonService", function ($scope, $http, GetService, commonService) {
    //#region DatePicker
    ...
    $scope.loadForwardedCases = function () {
        $("#loader").show();
        GetService.getUnsubsribedList(setPaginationOffset($scope.forwardedPagination), $scope.dateRang.str, $scope.dateRang.end, "/Report/GetAdmintionDataData").then(function (data) {
            debugger;
